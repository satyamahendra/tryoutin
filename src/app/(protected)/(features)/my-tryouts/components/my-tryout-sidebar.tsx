...
type MyTryoutSidebarProps = {
    categories: {value: string; label: string; count: number}[]
    tags: {id: string; name: string; count: number}[]
}

const MyTryoutSidebar = ({categories, tags}: MyTryoutSidebarProps) => {
        ...
        <aside className="flex flex-col gap-5 w-full shrink-0">
            <div className="relative">
                <InputGroup className="bg-background/80 backdrop-blur-sm border-border/50">
                    <InputGroupInput placeholder="Search my tryouts..." value={search} onChange={handleSearch} />
                    <InputGroupAddon>
                        <PiMagnifyingGlass />
                    </InputGroupAddon>
                </InputGroup>
...
export default MyTryoutSidebar
